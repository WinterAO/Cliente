...
Private Sub Form_Load()
    ...
    Set MinMayBack(0) = General_Load_Picture_From_Resource("128.bmp", False)
    Set MinMayBack(1) = General_Load_Picture_From_Resource("127.bmp", False)
...
Private Sub LoadButtons()
    ...
    Call cBotonMin.Initialize(imgMay, "203.bmp", _
                                    "204.bmp", _
                                    "205.bmp", Me)

    Call cBotonMay.Initialize(imgMin, "206.bmp", _
                                    "207.bmp", _
                                    "208.bmp", Me)
