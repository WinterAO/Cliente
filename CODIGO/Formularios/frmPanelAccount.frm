...
Begin VB.Form frmPanelAccount 
   ...
   Begin WinterAO.uAOButton uAOBorrarPersonaje 
      Height          =   615
      Left            =   840
      TabIndex        =   27
      Top             =   6360
   ...
   Begin VB.PictureBox picChar 
      ...
      Width           =   1140
   End
   Begin WinterAO.uAOButton uAOConectar 
      Height          =   615
      Left            =   9120
      TabIndex        =   28
      Top             =   7920
      ...
      EndProperty
   End
   Begin WinterAO.uAOButton uAOCrearPersonaje 
      Height          =   615
      Left            =   5040
      TabIndex        =   29
      Top             =   7920
      ...
      EndProperty
   End
   Begin WinterAO.uAOButton uAOSalir 
      Height          =   615
      Left            =   960
      TabIndex        =   30
      Top             =   7920
