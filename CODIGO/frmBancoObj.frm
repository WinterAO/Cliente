...
Private Sub Form_Load()
    ...
    Me.Picture = General_Load_Picture_From_Resource("180.bmp", False)
...
Private Sub LoadButtons()
    'CmdMoverBov(1).Picture = General_Load_Picture_From_Resource( "FlechaSubirObjeto.bmp", false)
    'CmdMoverBov(0).Picture = General_Load_Picture_From_Resource( "FlechaBajarObjeto.bmp", false)
    ...
    Call cBotonDepositarOro.Initialize(imgDepositarOro, "", "181.bmp", "180.bmp", Me)
    Call cBotonRetirarOro.Initialize(imgRetirarOro, "", "182.bmp", "182.bmp", Me)
    Call cBotonCerrar.Initialize(imgCerrar, "", "183.bmp", "183.bmp", Me)
