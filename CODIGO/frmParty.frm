...
On Error GoTo Form_Load_Err
    ...
    If EsPartyLeader Then
        ...
        If Language = "spanish" Then
            Me.Picture = General_Load_Picture_From_Resource("79.bmp", False)
        Else
            Me.Picture = General_Load_Picture_From_Resource("80.bmp", False)
        End If
        
        Me.Height = LEADER_FORM_HEIGHT
    Else
        If Language = "spanish" Then
            Me.Picture = General_Load_Picture_From_Resource("81.bmp", False)
        Else
            Me.Picture = General_Load_Picture_From_Resource("82.bmp", False)
        End If
...
Private Sub LoadButtons()
    ...
    Call cBotonAgregar.Initialize(imgAgregar, "62.bmp", _
                                    "63.bmp", _
                                    "61.bmp", Me)
                                    
    Call cBotonCerrar.Initialize(imgCerrar, "64.bmp", _
                                    "65.bmp", _
                                    "66.bmp", Me)
                                    
    Call cBotonDisolver.Initialize(imgDisolver, "67.bmp", _
                                    "68.bmp", _
                                    "69.bmp", Me)
                                    
    Call cBotonLiderGrupo.Initialize(imgLiderGrupo, "70.bmp", _
                                    "71.bmp", _
                                    "72.bmp", Me)
                                    
    Call cBotonExpulsar.Initialize(imgExpulsar, "73.bmp", _
                                    "74.bmp", _
                                    "75.bmp", Me)
                                    
    Call cBotonSalirParty.Initialize(imgSalirParty, "76.bmp", _
                                    "77.bmp", _
                                    "78.bmp", Me)
...
Private Sub imgExpulsar_Click()
    ...
    If Len(fName) > 0 Then
        ...
        If UCase$(fName) <> UCase$(CurrentUser.UserName) Then Call WriteRequestPartyForm
    End If
