...
Private Sub ActualizarImgClima(ByVal Estado As Byte)
    ...
    Select Case Estado
        ...
        Case e_estados.Amanecer
            frmMain.imgClima.Picture = General_Load_Picture_From_Resource("226.bmp")
        
        Case e_estados.MedioDia
            frmMain.imgClima.Picture = General_Load_Picture_From_Resource("226.bmp")
            
        Case e_estados.Tarde
            frmMain.imgClima.Picture = General_Load_Picture_From_Resource("225.bmp")
        
        Case e_estados.Noche
            frmMain.imgClima.Picture = General_Load_Picture_From_Resource("227.bmp")
